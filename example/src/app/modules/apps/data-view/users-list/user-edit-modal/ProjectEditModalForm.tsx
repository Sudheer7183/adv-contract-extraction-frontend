...
const ProjectEditModalForm: FC<Props> = ({ id }) => {
  ...
  // const someFunction = (x: any) => {
  //   console.log("catalog arr Fun--->", x);
  //   if (x != undefined) {
  //     const cf = x.catalogName
  //     // const cf1 = x.catalogName
  //     const id = x.id
  //     setCname(cf)
  //     setCid(id)
  //     // console.log("cf,cf1, id", cf, cf1, id);
  //   }
  //   console.log("cf, id", cname, cid);
  //   // return { value: cf, label: cf1, id: id }
  // }
  ...
  const onSubmit = async (e: any) => {
    ...
    //   description: description,
    //   active: isChecked,
    //   classificationFileId: selectedOption1.id,
    //   assignUser: assignUsers
    // }

    // request(`${BASEURL}graphql/`, createProject, variables).then((response: any) => console.log(response) )
    setAssignUsers([])
  }
