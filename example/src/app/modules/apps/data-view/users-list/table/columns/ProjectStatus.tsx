        ...
        <div className='d-flex align-items-center'>
            ...
            <div className='d-flex flex-column'>
                <a href='#' className='text-gray-800 text-hover-primary mb-1'>
                    ...
                    </svg></span> : dataStatus.node.active == false ? <p onClick={handlereactive}>ReAc</p> : (((fileStatus.filter((item: any) => item.project.projectName == dataStatus.node.projectName && item.fileStatus == "Review Completed")).length == dataStatus.node.totalFiles)) ? <p onClick={handledeactive}>DEA</p> : null}
                </a>
